...
UI_BASE_URL: Final[str] = os.environ.get("UI_BASE_URL", "http://host.docker.internal")
UI_BASE_PORT: Final[int] = int(os.environ.get("UI_BASE_PORT", "5173"))
BACKEND_API_BASE: Final[str] = os.environ.get("BACKEND_API_BASE", "http://host.docker.internal:8000/api/v1")
