...
@pytest.fixture(params=["light", "dark"], scope="function")
def ui_theme(request: pytest.FixtureRequest) -> Theme:
    """Parametrized fixture for light / dark themes."""
    return request.param  # type: ignore[return-value]


@pytest.fixture(params=["en-US", "uk-UA"], scope="function")
def ui_locale(request: pytest.FixtureRequest) -> str:
